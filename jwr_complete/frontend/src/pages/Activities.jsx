            ...
            {filtered.map((a, i) => (
              <div key={a.name} className={`act-card glossy-card reveal reveal-delay-${(i % 3) + 1}`}>
                <div className="act-card__image">
                  <img src={a.img} srcSet={`${a.img.replace("w=900", "w=450")} 450w, ${a.img} 900w`} sizes="(max-width: 768px) 100vw, 50vw" alt={a.alt || a.name} loading="lazy" style={{ aspectRatio: "16/9", objectFit: "cover", width: "100%", height: "100%" }} />
