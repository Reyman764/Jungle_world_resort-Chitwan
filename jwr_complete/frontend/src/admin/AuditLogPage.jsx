...
const ACTION_META = {
  ...
  BOOKING_SOFT_DELETED:        { icon: '⊘', label: 'Moved to Recycle Bin', color: '#b91c1c', group: 'booking' },
  BOOKING_RESTORED:            { icon: '⟲', label: 'Restored from Bin',   color: '#0d9488', group: 'booking' },
  BOOKING_PERMANENTLY_DELETED: { icon: '⊗', label: 'Permanently Deleted',  color: '#7f1d1d', group: 'booking' },
